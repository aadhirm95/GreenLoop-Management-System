...
public interface CS {
    ...
    static JLabel paintFooter(JPanel panel) {
        JLabel footer = new JLabel("Powered by CodX", SwingConstants.CENTER);
        footer.setForeground(Color.WHITE);
        footer.setOpaque(true);
        footer.setBackground(Color.decode("#071f38"));
        panel.add(footer);
        return footer;
    }

    static JLabel paintFooter(JFrame frame) {
        JLabel footer = new JLabel("Powered by CodX", SwingConstants.CENTER);
        footer.setForeground(Color.WHITE);
        footer.setOpaque(true);
        footer.setBackground(Color.decode("#071f38"));
